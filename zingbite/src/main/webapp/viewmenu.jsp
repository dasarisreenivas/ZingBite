<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List, com.app.zingbitemodels.Menu, com.app.zingbitemodels.User"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div class="menu-container">
		...
		<div class="menu-item">
			<img
				src="https://th.bing.com/th/id/OIP.jUfCu2A6ilKJAdybISEMgwHaHa?w=175&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3"
				alt="<%=item.getMenuName()%>" class="item-img">

			<div
				class="availability-badge <%=item.isAvailable() ? "available" : "unavailable"%>">
			...
			<div class="menu-details">
				...
				<button type="button" class="add-to-cart-btn"
					...
					<%=item.isAvailable() ? "" : "disabled"%>>Add to Cart</button>
				<%
				}
				%>
			</div>

import{d as e,g as t,i as n,l as r,n as i,p as a}from"./createLucideIcon-DINBtofy.js";import{t as o}from"./lock-B6A3C_RV.js";import{D as s,_ as c,f as l,o as u,p as d,r as f}from"./index-DvtySt6v.js";var p=t(a(),1),m=i(),h=()=>{let[t,i]=(0,p.useState)(``),[a,h]=(0,p.useState)(``),[g,_]=(0,p.useState)(``),[v,y]=(0,p.useState)(!1),[b,x]=(0,p.useState)(null),{user:S,loading:C,login:w}=(0,p.useContext)(s),{showAlert:T}=f(),E=r(),[D]=e(),O=D.get(`redirect`)||`/`;(0,p.useEffect)(()=>{C||S&&E(k(S,O),{replace:!0})},[S,C,O,E]);function k(e,t){return e.role===`delivery_partner`?t.startsWith(`/info/`)?t:`/delivery`:e.role===`restaurant_admin`?t.startsWith(`/info/`)?t:`/restaurant-admin`:e.role===`super_admin`?t.startsWith(`/info/`)?t:`/admin`:t}return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .login-page {
          display: flex;
      ...
      `}),(0,m.jsxs)(`div`,{className:`login-page page-enter`,children:[(0,m.jsxs)(`div`,{className:`login-hero`,children:[(0,m.jsx)(`img`,{src:`https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=2070&auto=format&fit=crop`,alt:`Food`,loading:`lazy`}),(0,m.jsxs)(`div`,{className:`login-hero-overlay`,children:[(0,m.jsxs)(`h2`,{children:[`Welcome`,(0,m.jsx)(`br`,{}),`Back!`]}),(0,m.jsx)(`p`,{children:`Order your favorite food from the best restaurants in town`}),(0,m.jsxs)(`div`,{className:`hero-flame`,children:[(0,m.jsx)(c,{size:16,color:`#F7374F`}),` 50% OFF your first order`]})]})]}),(0,m.jsx)(`div`,{className:`login-form-section`,children:(0,m.jsxs)(`div`,{className:`login-form-container`,children:[(0,m.jsxs)(`div`,{className:`brand-icon`,children:[(0,m.jsx)(c,{size:22,className:`flame-icon`,fill:`#F7374F`}),(0,m.jsx)(`span`,{style:{fontWeight:800,fontSize:`1.1rem`,color:`var(--text-primary)`},children:`ZingBite`})]}),(0,m.jsx)(`h2`,{children:`Login`}),(0,m.jsxs)(`p`,{className:`subtitle`,children:[`or `,(0,m.jsx)(n,{to:`/register`,children:`create an account`})]}),g&&(0,m.jsxs)(`div`,{className:`login-error`,children:[(0,m.jsx)(u,{size:16}),` `,g]}),(0,m.jsxs)(`form`,{onSubmit:async e=>{e.preventDefault(),_(``),y(!0);let n=await w(t,a);y(!1),n.success?E(k(n.user,O)):_(n.error||`Login failed`)},children:[(0,m.jsxs)(`div`,{className:`form-field ${b===`email`?`focused`:``} ${t?`filled`:``}`,children:[(0,m.jsx)(l,{size:16,className:`field-icon`}),(0,m.jsx)(`label`,{children:`Email address`}),(0,m.jsx)(`input`,{type:`email`,value:t,onChange:e=>i(e.target.value),onFocus:()=>x(`email`),onBlur:()=>x(null),required:!0})]}),(0,m.jsxs)(`div`,{className:`form-field ${b===`password`?`focused`:``} ${a?`filled`:``}`,children:[(0,m.jsx)(o,{size:16,className:`field-icon`}),(0,m.jsx)(`label`,{children:`Password`}),(0,m.jsx)(`input`,{type:`password`,value:a,onChange:e=>h(e.target.value),onFocus:()=>x(`password`),onBlur:()=>x(null),required:!0})]}),(0,m.jsx)(`button`,{type:`submit`,className:`login-submit`,disabled:v,children:v?(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(d,{size:16,className:`spin-icon`}),` Logging in...`]}):`LOGIN`})]}),(0,m.jsx)(`div`,{className:`login-divider`,children:`or continue with`}),(0,m.jsxs)(`div`,{className:`social-login-grid`,children:[(0,m.jsxs)(`button`,{type:`button`,className:`social-btn`,onClick:()=>T(`Google sign-in coming soon!`,`info`),children:[(0,m.jsxs)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,children:[(0,m.jsx)(`path`,{fill:`#4285F4`,d:`M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z`}),(0,m.jsx)(`path`,{fill:`#34A853`,d:`M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z`}),(0,m.jsx)(`path`,{fill:`#FBBC05`,d:`M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z`}),(0,m.jsx)(`path`,{fill:`#EA4335`,d:`M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z`})]}),`Google`]}),(0,m.jsxs)(`button`,{type:`button`,className:`social-btn`,onClick:()=>T(`GitHub sign-in coming soon!`,`info`),children:[(0,m.jsx)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,children:(0,m.jsx)(`path`,{fill:`#333`,d:`M12 0C5.37 0 0 5.37 0 12c0 5.3 3.44 9.8 8.2 11.39.6.11.82-.26.82-.58 0-.29-.01-1.24-.02-2.24-3.34.73-4.04-1.42-4.04-1.42-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.73.08-.73 1.2.09 1.84 1.24 1.84 1.24 1.07 1.83 2.81 1.3 3.5 1 .1-.78.42-1.3.76-1.6-2.67-.3-5.47-1.33-5.47-5.93 0-1.31.47-2.38 1.24-3.22-.12-.3-.54-1.52.12-3.17 0 0 1.01-.32 3.3 1.23.96-.27 1.98-.4 3-.4s2.04.13 3 .4c2.29-1.55 3.3-1.23 3.3-1.23.66 1.65.24 2.87.12 3.17.77.84 1.24 1.91 1.24 3.22 0 4.61-2.8 5.63-5.48 5.93.43.37.82 1.1.82 2.22 0 1.6-.01 2.89-.01 3.28 0 .32.22.7.83.58C20.56 21.8 24 17.3 24 12 24 5.37 18.63 0 12 0z`})}),`GitHub`]})]})]})})]})]})};export{h as default};
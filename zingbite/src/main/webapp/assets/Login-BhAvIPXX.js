import{a as e,f as t,g as n,m as r,n as i,u as a}from"./createLucideIcon-DnU5s7Zs.js";import{t as o}from"./lock-BudfzplA.js";import{a as s,d as c,m as l,n as u,u as d,w as f}from"./index-CLDdiuGX.js";var p=n(r(),1),m=i(),h=()=>{let[n,r]=(0,p.useState)(``),[i,h]=(0,p.useState)(``),[g,_]=(0,p.useState)(``),[v,y]=(0,p.useState)(!1),[b,x]=(0,p.useState)(null),{user:S,loading:C,login:w}=(0,p.useContext)(f),{showAlert:T}=u(),E=a(),[D]=t(),O=D.get(`redirect`)||`/`;(0,p.useEffect)(()=>{C||S&&E(k(S,O),{replace:!0})},[S,C,O,E]);function k(e,t){return e.role===`delivery_partner`?t.startsWith(`/info/`)?t:`/delivery`:e.role===`restaurant_admin`?t.startsWith(`/info/`)?t:`/restaurant-admin`:e.role===`super_admin`?t.startsWith(`/info/`)?t:`/admin`:t}return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .login-page {
          display: flex;

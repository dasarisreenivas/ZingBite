import{t as e}from"./indian-rupee-QXLsQZT7.js";import{n as t,t as n}from"./ChatWidget-D40BqyOP.js";import{A as r,C as i,D as a,E as o,T as s,a as c,h as l,i as u,k as d,m as f,n as p,o as m,r as h,s as g,t as _,w as v,x as y}from"./index-BxGC8YKb.js";var b=i(`check`,[[`path`,{d:`M20 6 9 17l-5-5`,key:`1gmf2c`}]]),x=i(`user-check`,[[`path`,{d:`m16 11 2 2 4-4`,key:`9rsbq5`}],[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`,key:`1yyitq`}],[`circle`,{cx:`9`,cy:`7`,r:`4`,key:`nufk8`}]]),S=r(d(),1),C=s(),w=()=>{let{user:r,logout:i,loading:s}=(0,S.useContext)(v),d=a(),{showAlert:w}=_(),[T,E]=(0,S.useState)(`metrics`),[D,ee]=(0,S.useState)({userCount:0,restaurantCount:0,orderCount:0,totalRevenue:0,users:[],applications:[],restaurantRequests:[]}),[O,k]=(0,S.useState)(!0),[A,j]=(0,S.useState)(null),[M,N]=(0,S.useState)(null),[P,F]=(0,S.useState)(null),[I,L]=(0,S.useState)({name:``,cuisine:``,address:``,deliveryTime:``,imagePath:``}),[R,z]=(0,S.useState)({title:``,department:``,location:``,description:``}),[B,V]=(0,S.useState)(!1),[H,U]=(0,S.useState)(!1),W=async(e=!1)=>{try{ee((await o.get(`/api/super-admin`)).data),e||j(null)}catch(t){console.error(t),e||j(t.response?.data?.error||`Access denied or failed to load super admin stats.`)}finally{e||k(!1)}};(0,S.useEffect)(()=>{if(s)return;if(!r){d(`/login?redirect=/admin`);return}W(!1);let e=setInterval(()=>{document.visibilityState===`visible`&&W(!0)},12e3);return()=>clearInterval(e)},[r,s]);let G=async(e,t)=>{N(`role-${e}`);try{await o.post(`/api/super-admin`,{action:`changeUserRole`,userId:e,role:t}),await W()}catch{w(`Failed to update user role.`,`error`)}finally{N(null)}},K=async(e,t)=>{N(`app-${e}`);try{await o.post(`/api/super-admin`,{action:`updateApplicationStatus`,appId:e,status:t}),await W()}catch{w(`Failed to update application status.`,`error`)}finally{N(null)}},q=async(e,t)=>{N(`req-${e}`);try{await o.post(`/api/super-admin`,{action:`reviewRestaurant`,requestId:e,status:t}),w(`Restaurant Request successfully ${t}!`,`success`),await W()}catch{w(`Failed to review restaurant request.`,`error`)}finally{N(null)}},J=async e=>{if(e.preventDefault(),!I.name||!I.cuisine||!I.address){w(`Please fill out all required fields.`,`warning`);return}V(!0);try{await o.post(`/api/super-admin`,{action:`addRestaurant`,name:I.name,cuisine:I.cuisine,address:I.address,deliveryTime:I.deliveryTime||void 0,imagePath:I.imagePath||void 0}),w(`Restaurant added successfully!`,`success`),L({name:``,cuisine:``,address:``,deliveryTime:``,imagePath:``}),await W()}catch{w(`Failed to create restaurant.`,`error`)}finally{V(!1)}},Y=async e=>{if(e.preventDefault(),!R.title||!R.department||!R.location||!R.description){w(`Please fill out all required fields.`,`warning`);return}U(!0);try{await o.post(`/api/super-admin`,{action:`addJob`,title:R.title,department:R.department,location:R.location,description:R.description}),w(`Job listing published successfully!`,`success`),z({title:``,department:``,location:``,description:``}),await W()}catch{w(`Failed to create job posting.`,`error`)}finally{U(!1)}};if(s||O)return(0,C.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,alignItems:`center`,flex:1,minHeight:`400px`},children:(0,C.jsx)(f,{size:36,style:{animation:`spin 1s linear infinite`,color:`var(--brand-red)`}})});if(A)return(0,C.jsxs)(`div`,{style:{maxWidth:`600px`,margin:`80px auto`,textAlign:`center`,padding:`32px`,background:`#fff`,border:`1px solid var(--border-medium)`,borderRadius:`12px`,boxShadow:`var(--shadow-md)`},className:`fade-in`,children:[(0,C.jsx)(u,{size:48,style:{color:`var(--brand-red)`,marginBottom:`16px`,margin:`0 auto 16px`}}),(0,C.jsx)(`h3`,{style:{fontSize:`1.4rem`,fontWeight:800},children:`Access Restricted`}),(0,C.jsx)(`p`,{style:{color:`var(--text-secondary)`,marginTop:`8px`,marginBottom:`24px`},children:A}),(0,C.jsxs)(`div`,{style:{display:`flex`,justifyContent:`center`,gap:`12px`},children:[(0,C.jsx)(`button`,{onClick:()=>d(`/login?redirect=/admin`),className:`btn-primary`,style:{width:`auto`,padding:`10px 20px`,fontSize:`0.9rem`,borderRadius:`4px`},children:`Switch Account`}),(0,C.jsx)(`button`,{onClick:async()=>{await i(),d(`/login?redirect=/admin`)},className:`portal-logout-btn`,children:`Logout`})]})]});let X=(D.restaurantRequests||[]).filter(e=>e.status===`Pending`),Z=(D.restaurantRequests||[]).filter(e=>e.status!==`Pending`),Q=(D.applications||[]).filter(e=>e.jobTitle===`Delivery Rider`),$=(D.applications||[]).filter(e=>e.jobTitle!==`Delivery Rider`);return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`style`,{children:`
        .admin-container {
          max-width: 1200px;
          margin: 32px auto;
          padding: 0 20px;

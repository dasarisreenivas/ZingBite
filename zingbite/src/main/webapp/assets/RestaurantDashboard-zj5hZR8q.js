import{t as e}from"./chevron-right-COw4sk-Q.js";import{t}from"./indian-rupee-CUB8zqXe.js";import{A as n,D as r,E as i,O as a,T as o,a as s,b as c,d as l,f as u,h as d,j as f,l as ee,m as p,t as te,u as ne,v as m,w as h,y as g}from"./index-DA02D76-.js";var _=h(`utensils`,[[`path`,{d:`M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2`,key:`cjf0a3`}],[`path`,{d:`M7 2v20`,key:`1473qp`}],[`path`,{d:`M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7`,key:`j28e5`}]]),v=f(n(),1),y=i(),b=()=>{let{user:n,logout:i,loading:f}=(0,v.useContext)(o),h=a(),{showAlert:b}=te(),[x,S]=(0,v.useState)(`orders`),[C,w]=(0,v.useState)({restaurant:null,menu:[],orders:[],request:null}),[re,T]=(0,v.useState)(!0),[E,D]=(0,v.useState)(null),[O,k]=(0,v.useState)({name:``,cuisine:``,address:``,deliveryTime:`30 mins`,imagePath:``,licenseNo:``,aadhaarNo:``,gstNo:``}),[A,j]=(0,v.useState)(!1),[ie,M]=(0,v.useState)(!1),[N,P]=(0,v.useState)({name:``,price:``,description:``,imagePath:``}),[F,I]=(0,v.useState)(!1),[L,R]=(0,v.useState)(null),[z,ae]=(0,v.useState)(``),[B,oe]=(0,v.useState)(`All`),V=async(e=!1)=>{try{w((await r.get(`/api/restaurant-admin`)).data),e||D(null)}catch(t){console.error(t),e||D(t.response?.data?.error||`Failed to load restaurant data.`)}finally{e||T(!1)}};(0,v.useEffect)(()=>{if(f)return;if(!n){h(`/login?redirect=/restaurant-admin`);return}if(n.role!==`restaurant_admin`&&n.role!==`customer`){D(`Access Restricted. You are currently logged in as a `+n.role+`. Only Restaurant Admins or onboarding partners can access this portal.`),T(!1);return}V(!1);let e=new EventSource(`/api/stream?topic=restaurant_orders`);return e.onmessage=e=>{try{let t=JSON.parse(e.data);if(console.log(`[ZingBite SSE] Received real-time restaurant dashboard update:`,t),t&&(t.event===`new_order`||t.event===`new_request`))try{let e=new Audio(`https://assets.mixkit.co/active_storage/sfx/2869/2869-84.wav`);e.volume=.5,e.play()}catch(e){console.log(`Audio play blocked by browser autoplay policy:`,e)}V(!0)}catch(e){console.error(`[ZingBite SSE] Error on message:`,e)}},e.onerror=e=>{console.error(`[ZingBite SSE] EventSource connection error:`,e)},()=>{e.close()}},[n,f]);let H=async e=>{if(e.preventDefault(),!O.name||!O.cuisine||!O.address||!O.licenseNo||!O.aadhaarNo||!O.gstNo){b(`Please fill out all required fields.`,`warning`);return}j(!0);try{await r.post(`/api/restaurant-admin`,{action:`submitRestaurantRequest`,name:O.name,cuisine:O.cuisine,address:O.address,deliveryTime:O.deliveryTime,imagePath:O.imagePath||void 0,licenseNo:O.licenseNo,aadhaarNo:O.aadhaarNo,gstNo:O.gstNo}),b(`Onboarding request submitted successfully! Super admin will verify your documents.`,`success`),await V()}catch{b(`Failed to submit onboarding request.`,`error`)}finally{j(!1)}},U=async(e,t)=>{try{await r.post(`/api/restaurant-admin`,{action:`toggleAvailability`,menuId:e,isAvailable:!t}),w(n=>({...n,menu:(n.menu||[]).map(n=>n.menuId===e?{...n,isAvailable:!t}:n)}))}catch{b(`Failed to update availability.`,`error`)}},W=async e=>{if(e.preventDefault(),!N.name||!N.price||!N.description){b(`Please fill out all required fields.`,`warning`);return}I(!0);try{await r.post(`/api/restaurant-admin`,{action:`addMenuItem`,name:N.name,price:parseFloat(N.price),description:N.description,imagePath:N.imagePath||void 0,restaurantId:C.restaurant.restaurantId}),M(!1),P({name:``,price:``,description:``,imagePath:``}),await V()}catch{b(`Failed to add menu item.`,`error`)}finally{I(!1)}},G=async(e,t)=>{R(e);try{await r.post(`/api/restaurant-admin`,{action:`updateOrderStatus`,orderId:e,status:t}),await V()}catch{b(`Failed to update order status.`,`error`)}finally{R(null)}},K=t=>{let n=(e=>{switch(e){case`Placed`:case`Accepted`:return 0;case`Preparing`:return 1;case`Waiting to Dispatch`:return 2;case`Out for Delivery`:return 3;case`Delivered`:return 5;default:return 0}})(t.status);return(0,y.jsx)(`div`,{className:`premium-stepper-container`,children:(0,y.jsx)(`div`,{className:`premium-stepper`,children:[{key:0,label:`Placed`,statusName:`Accepted`},{key:1,label:`Preparing`,statusName:`Preparing`,actionLabel:`Start Cooking`},{key:2,label:`Food Ready`,statusName:`Waiting to Dispatch`,actionLabel:`Mark Ready`},{key:3,label:`Dispatched`,statusName:`Out for Delivery`,actionLabel:`Dispatch`},{key:4,label:`Delivered`,statusName:`Delivered`}].map((r,i)=>{let a=n>i,o=n===i,s=n<i,c=i===1&&n===0||i===2&&n===1||i===3&&n===2,l=`stepper-node`;return a&&(l+=` completed`),o&&(l+=` active`),s&&(l+=` pending`),c&&(l+=` actionable`),(0,y.jsxs)(v.Fragment,{children:[i>0&&(0,y.jsx)(`div`,{className:`stepper-line ${a||o?`active`:``}`}),(0,y.jsxs)(`div`,{className:l,children:[c?(0,y.jsxs)(`button`,{disabled:L===t.orderId,onClick:()=>G(t.orderId,r.statusName),className:`stepper-btn-node`,title:r.actionLabel,children:[L===t.orderId?(0,y.jsx)(p,{className:`spin`,size:14}):i===1?(0,y.jsx)(_,{size:14}):i===2?(0,y.jsx)(g,{size:14}):(0,y.jsx)(e,{size:14}),(0,y.jsx)(`span`,{className:`stepper-btn-label`,children:r.actionLabel})]}):(0,y.jsx)(`div`,{className:`stepper-circle`,children:a?(0,y.jsx)(g,{size:14}):i+1}),(0,y.jsx)(`span`,{className:`stepper-label`,children:r.label})]})]},r.key)})})})};if(f||re)return(0,y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,alignItems:`center`,flex:1,minHeight:`400px`},children:(0,y.jsx)(p,{size:36,style:{animation:`spin 1s linear infinite`,color:`var(--brand-red)`}})});if(E)return(0,y.jsxs)(`div`,{style:{maxWidth:`600px`,margin:`80px auto`,textAlign:`center`,padding:`32px`,background:`#fff`,border:`1px solid var(--border-medium)`,borderRadius:`12px`,boxShadow:`var(--shadow-md)`},className:`fade-in`,children:[(0,y.jsx)(c,{size:48,style:{color:`var(--brand-red)`,marginBottom:`16px`,margin:`0 auto 16px`}}),(0,y.jsx)(`h3`,{style:{fontSize:`1.4rem`,fontWeight:800},children:`Access Restricted`}),(0,y.jsx)(`p`,{style:{color:`var(--text-secondary)`,marginTop:`8px`,marginBottom:`24px`},children:E}),(0,y.jsxs)(`div`,{style:{display:`flex`,justifyContent:`center`,gap:`12px`},children:[(0,y.jsx)(`button`,{onClick:()=>h(`/login?redirect=/restaurant-admin`),className:`btn-primary`,style:{width:`auto`,padding:`10px 20px`,fontSize:`0.9rem`,borderRadius:`4px`},children:`Switch Account`}),(0,y.jsx)(`button`,{onClick:async()=>{await i(),h(`/login?redirect=/restaurant-admin`)},className:`portal-logout-btn`,children:`Logout`})]})]});let{restaurant:q,menu:se=[],orders:J=[],request:Y}=C||{},X=(J||[]).filter(e=>(e.status||``).toLowerCase()===`delivered`),ce=(J||[]).filter(e=>(e.status||``).toLowerCase()!==`delivered`).length,Z=X.reduce((e,t)=>e+(t.total||0),0),le=X.length>0?Z/X.length:0;if(!q){let e=Y&&Y.status===`Pending`,t=Y&&Y.status===`Rejected`;return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(`style`,{children:`
          .onboard-container {
            max-width: 650px;
            margin: 48px auto;
            padding: 32px;

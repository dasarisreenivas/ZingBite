import{d as e,g as t,l as n,m as r,n as i,r as a,t as o,u as s}from"./createLucideIcon-DnU5s7Zs.js";import{t as c}from"./building-2-CBGrLSsR.js";import{t as l}from"./chevron-down-IwT-alHZ.js";import{t as u}from"./phone-DOvBU6-6.js";import{t as d}from"./send-CBtMFMV_.js";import{_ as f,d as p,l as m,n as h,u as g,v as _,w as v,x as y}from"./index-DbXf8GKr.js";var b=o(`external-link`,[[`path`,{d:`M15 3h6v6`,key:`1q9fwt`}],[`path`,{d:`M10 14 21 3`,key:`gplh6r`}],[`path`,{d:`M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6`,key:`a6xqqp`}]]),x=t(r(),1),S=i(),C=x.memo(()=>{let{sectionId:t}=e(),r=n(),i=s(),{showAlert:o}=h(),C=t||r.pathname.replace(/^\/?(?:info\/)?/,``)||`about-us`,{user:w,updateUser:ee}=(0,x.useContext)(v),[T,E]=(0,x.useState)(!1),[D,O]=(0,x.useState)(!1),[k,A]=(0,x.useState)({name:``,email:``,subject:``,message:``}),[j,M]=(0,x.useState)(!1),[N,P]=(0,x.useState)({restName:``,owner:``,email:w?.email||``,phone:``,city:``,cuisine:``,address:``,licenseNo:``,aadhaarNo:``,gstNo:``}),[F,I]=(0,x.useState)(!1),[L,R]=(0,x.useState)({name:``,city:``,vehicle:`bike`,phone:``}),[z,B]=(0,x.useState)(!1),[V,H]=(0,x.useState)(typeof window<`u`&&!!window.L),U=(0,x.useRef)(null),W=(0,x.useRef)(null),G=(0,x.useRef)(null),[K,q]=(0,x.useState)(!1);(0,x.useEffect)(()=>{if(window.L){H(!0);return}let e=document.querySelector(`link[href*="leaflet.css"]`);e||(e=document.createElement(`link`),e.rel=`stylesheet`,e.href=`https://unpkg.com/leaflet@1.9.4/dist/leaflet.css`,document.head.appendChild(e));let t=document.querySelector(`script[src*="leaflet.js"]`);t||(t=document.createElement(`script`),t.src=`https://unpkg.com/leaflet@1.9.4/dist/leaflet.js`,t.async=!0,t.onload=()=>{let e=setInterval(()=>{window.L&&(H(!0),clearInterval(e))},50)},document.body.appendChild(t))},[]);let J=async(e,t)=>{q(!0);try{let n=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=18`)).json();if(n){let e=n.display_name||``,t=n.address?.city||n.address?.town||n.address?.village||n.address?.suburb||``;C===`partner-with-us`?P(n=>({...n,address:e,city:t})):C===`ride-with-us`&&R(n=>({...n,city:t||e}))}}catch(e){console.error(`Reverse geocoding error:`,e)}finally{q(!1)}},Y=()=>{if(!navigator.geolocation){o(`Geolocation is not supported by your browser.`,`error`);return}navigator.geolocation.getCurrentPosition(e=>{let{latitude:t,longitude:n}=e.coords;W.current&&(W.current.setView([t,n],16),G.current&&G.current.setLatLng([t,n])),J(t,n)},e=>{o(`Error retrieving location: `+e.message,`error`)})},X=(0,x.useCallback)(()=>{if(W.current){try{W.current.remove()}catch{}W.current=null,G.current=null}},[]);(0,x.useEffect)(()=>{let e=C===`partner-with-us`||C===`ride-with-us`;if(!V||!U.current||!e||!w||W.current)return;let t=window.L;if(!t)return;let n=12.9716,r=77.5946,i=t.map(U.current).setView([n,r],14);W.current=i,t.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{maxZoom:19,attribution:`&copy; OpenStreetMap contributors`}).addTo(i);let a=t.divIcon({html:`<div style="font-size: 24px; text-align: center; line-height: 24px;">📍</div>`,className:`custom-info-marker`,iconSize:[24,24],iconAnchor:[12,12]}),o=t.marker([n,r],{icon:a,draggable:!0}).addTo(i);return G.current=o,o.on(`dragend`,()=>{let e=o.getLatLng();J(e.lat,e.lng)}),i.on(`click`,e=>{o.setLatLng(e.latlng),J(e.latlng.lat,e.latlng.lng)}),J(n,r),X},[V,C,w,X]),(0,x.useEffect)(()=>{w?.email&&(P(e=>e.email?e:{...e,email:w.email}),A(e=>e.email?e:{...e,email:w.email}),R(e=>e.name?e:{...e,name:w.name||``}))},[w?.email]);let[Z,te]=(0,x.useState)(null),[ne,re]=(0,x.useState)(!1),[Q,$]=(0,x.useState)(null);(0,x.useEffect)(()=>{if(C===`partner-with-us`){let e=document.getElementById(`partner-with-us-form`);if(e){setTimeout(()=>e.scrollIntoView({behavior:`smooth`,block:`start`}),100);return}}if(C===`ride-with-us`){let e=document.getElementById(`ride-with-us-form`);if(e){setTimeout(()=>e.scrollIntoView({behavior:`smooth`,block:`start`}),100);return}}window.scrollTo({top:0,behavior:`smooth`})},[C]);let ie=async e=>{e.preventDefault();try{await a.post(`/api/contact`,{name:k.name,email:k.email,subject:k.subject,message:k.message}),M(!0),setTimeout(()=>{A({name:``,email:``,subject:``,message:``}),M(!1)},4e3)}catch(e){o(e.response?.data?.error||`Failed to send message.`,`error`)}},ae=async e=>{if(e.preventDefault(),!w){o(`You must be logged in to apply as a partner`,`error`);return}if(!N.address||!N.licenseNo||!N.aadhaarNo||!N.gstNo){o(`Please fill out all required onboarding fields, including map location coordinates.`,`warning`);return}E(!0);try{(await a.post(`/api/restaurant-admin`,{action:`submitRestaurantRequest`,name:N.restName,owner:N.owner,email:N.email,phone:N.phone,city:N.city,cuisine:N.cuisine||`Multi-Cuisine`,address:N.address,deliveryTime:`30 mins`,imagePath:`https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=2070&auto=format&fit=crop`,licenseNo:N.licenseNo,aadhaarNo:N.aadhaarNo,gstNo:N.gstNo})).data.success&&(I(!0),o(`Partner request submitted! Pending admin approval.`,`success`))}catch(e){o(e.response?.data?.error||`Failed to submit partner application.`,`error`)}finally{E(!1)}},oe=async e=>{if(e.preventDefault(),!w){o(`You must be logged in to apply as a rider`,`error`);return}O(!0);try{let e=(await a.get(`/api/careers?action=jobs`)).data||[],t=e.find(e=>e.title&&e.title.toLowerCase().includes(`rider`));if(!t&&e.length>0&&(t=e[0]),!t)throw Error(`Delivery Rider position not found in careers listing.`);(await a.post(`/api/careers`,{action:`apply`,jobId:t.id,name:L.name,email:w.email,phone:L.phone,resumeUrl:`https://zingbite.com/resumes/rider_application.pdf`,city:L.city,vehicle:L.vehicle})).data.success&&(B(!0),o(`Rider application submitted! Pending admin approval.`,`success`))}catch(e){o(e.message||e.response?.data?.error||`Failed to submit rider application.`,`error`)}finally{O(!1)}},se=e=>{$(Q===e?null:e)};return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`style`,{children:`
        .info-page-layout {
          max-width: 1200px;

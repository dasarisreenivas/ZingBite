import{n as e,t}from"./ChatWidget-D40BqyOP.js";import{A as n,C as r,D as i,E as a,T as o,b as s,c,f as l,h as u,k as d,m as f,t as p,w as m,y as h}from"./index-BxGC8YKb.js";var g=r(`inbox`,[[`polyline`,{points:`22 12 16 12 14 15 10 15 8 12 2 12`,key:`o97t9d`}],[`path`,{d:`M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z`,key:`oot6mr`}]]),_=r(`key-round`,[[`path`,{d:`M2.586 17.414A2 2 0 0 0 2 18.828V21a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h1a1 1 0 0 0 1-1v-1a1 1 0 0 1 1-1h.172a2 2 0 0 0 1.414-.586l.814-.814a6.5 6.5 0 1 0-4-4z`,key:`1s6t7t`}],[`circle`,{cx:`16.5`,cy:`7.5`,r:`.5`,fill:`currentColor`,key:`w0ekpg`}]]),v=r(`lock`,[[`rect`,{width:`18`,height:`11`,x:`3`,y:`11`,rx:`2`,ry:`2`,key:`1w4ew1`}],[`path`,{d:`M7 11V7a5 5 0 0 1 10 0v4`,key:`fwvmzm`}]]),y=n(d(),1),b=o(),x=()=>{let{user:n}=(0,y.useContext)(m),r=i(),{showAlert:o}=p(),[d,x]=(0,y.useState)(`jobs`),[S,C]=(0,y.useState)([]),[w,T]=(0,y.useState)([]),[E,D]=(0,y.useState)([]),[O,k]=(0,y.useState)(!0),[A,j]=(0,y.useState)(!1),[M,N]=(0,y.useState)(!1),[P,F]=(0,y.useState)(null),[I,L]=(0,y.useState)(null),[R,z]=(0,y.useState)({name:``,email:``,phone:``,resumeUrl:``}),[B,V]=(0,y.useState)(!1),[H,U]=(0,y.useState)(!1),[W,G]=(0,y.useState)(``),[K,q]=(0,y.useState)(`1234`),[J,Y]=(0,y.useState)(``),X=async(e=!1)=>{try{C((await a.get(`/api/careers?action=jobs`)).data)}catch(e){console.error(`Failed to load jobs:`,e)}finally{e||k(!1)}},Z=async(e=!1)=>{if(n){e||j(!0);try{T((await a.get(`/api/careers?action=applications`)).data)}catch(e){console.error(`Failed to load applications:`,e)}finally{e||j(!1)}}},Q=async(e=!1)=>{if(n){e||N(!0);try{D((await a.get(`/api/careers?action=notifications`)).data)}catch(e){console.error(`Failed to load notifications:`,e)}finally{e||N(!1)}}};return(0,y.useEffect)(()=>{X(!1);let e=setInterval(()=>X(!0),5e3),t=null;return n&&(Z(!1),Q(!1),t=setInterval(()=>{Z(!0),Q(!0)},4e3)),()=>{clearInterval(e),t&&clearInterval(t)}},[n]),(0,y.useEffect)(()=>{n&&z({name:n.userName||n.username||``,email:n.email||``,phone:String(n.phoneNumber||n.mobile||``),resumeUrl:``})},[n]),O?(0,b.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,alignItems:`center`,height:`400px`},children:(0,b.jsx)(f,{size:36,style:{animation:`spin 1s linear infinite`,color:`var(--brand-red)`}})}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(`style`,{children:`
        .careers-container {
          max-width: 1200px;
          margin: 32px auto;
          padding: 0 20px;

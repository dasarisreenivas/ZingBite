import{A as e,C as t,E as n,T as r,c as i,k as a,m as o,n as s}from"./index-BxGC8YKb.js";var c=t(`message-square`,[[`path`,{d:`M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z`,key:`18887p`}]]),l=e(a(),1),u=r(),d=({type:e,targetId:t,userId:r,userName:a,receiverId:d,placeholder:f=`Type a message...`,initialOpen:p=!1,onClose:m})=>{let[h,g]=(0,l.useState)(p),[_,v]=(0,l.useState)([]),[y,b]=(0,l.useState)(``),[x,S]=(0,l.useState)(!1),[C,w]=(0,l.useState)(!1),T=(0,l.useRef)(null),E=(0,l.useRef)(null),D=()=>{E.current?.scrollIntoView({behavior:`smooth`})};(0,l.useEffect)(()=>{h&&D()},[_,h]);let O=async()=>{S(!0);try{let r=`/api/chat?`;e===`order`?r+=`orderId=${t}`:r+=`applicationId=${t}`,v((await n.get(r)).data||[])}catch(e){console.error(`Failed to load chat history:`,e)}finally{S(!1)}},k=()=>{T.current&&T.current.close();let n=String(t).replace(/^ZB-/,``).trim(),i=`${window.location.protocol===`https:`?`wss://`:`ws://`}${window.location.host}/zingbite/api/ws/chat/${e}/${n}/${r}`;console.log(`[WebSocket] Connecting to:`,i);let a=new WebSocket(i);T.current=a,a.onopen=()=>{console.log(`[WebSocket] Connected successfully.`),w(!0)},a.onmessage=e=>{try{let t=JSON.parse(e.data);t&&!t.error&&v(e=>e.some(e=>e.id===t.id||e.timestamp===t.timestamp&&e.messageText===t.messageText)?e:[...e,t])}catch(e){console.error(`WebSocket message parse error:`,e)}},a.onclose=e=>{console.log(`[WebSocket] Connection closed:`,e.reason),w(!1)},a.onerror=e=>{console.error(`[WebSocket] Connection error:`,e),w(!1)}};return(0,l.useEffect)(()=>(h?(O(),k()):T.current&&=(T.current.close(),null),()=>{T.current&&T.current.close()}),[h,t]),(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`style`,{children:`
        .chat-widget-fab {
          position: fixed;
          bottom: 24px;
          right: 90px;

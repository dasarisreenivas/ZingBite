import{t as e}from"./chevron-right-BxY0ugEN.js";import{t}from"./indian-rupee-CzGNaXe5.js";import{A as n,C as r,D as i,N as a,O as o,P as s,S as c,d as l,f as u,g as d,j as ee,k as f,o as p,p as m,t as te,u as ne,v as re,x as ie}from"./index--LVRK4os.js";var h=i(`utensils`,[[`path`,{d:`M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2`,key:`cjf0a3`}],[`path`,{d:`M7 2v20`,key:`1473qp`}],[`path`,{d:`M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7`,key:`j28e5`}]]),g=s(a(),1),_=f(),v=6,y=()=>{let{user:i,logout:a,loading:s}=(0,g.useContext)(o),f=ee(),{showAlert:y}=te(),[b,x]=(0,g.useState)(`orders`),[S,C]=(0,g.useState)({restaurant:null,menu:[],orders:[],request:null}),[ae,w]=(0,g.useState)(!0),[T,E]=(0,g.useState)(null),[D,O]=(0,g.useState)({name:``,cuisine:``,address:``,deliveryTime:`30 mins`,imagePath:``,licenseNo:``,aadhaarNo:``,gstNo:``}),[k,A]=(0,g.useState)(!1),[oe,j]=(0,g.useState)(!1),[M,N]=(0,g.useState)({name:``,price:``,description:``,imagePath:``}),[P,F]=(0,g.useState)(!1),[I,L]=(0,g.useState)(null),[R,z]=(0,g.useState)(``),[B,se]=(0,g.useState)(`All`),[V,H]=(0,g.useState)(v),[U,W]=(0,g.useState)(v),G=async(e=!1)=>{try{C((await n.get(`/api/restaurant-admin`)).data),e||E(null)}catch(t){console.error(t),e||E(t.response?.data?.error||`Failed to load restaurant data.`)}finally{e||w(!1)}};(0,g.useEffect)(()=>{if(s)return;if(!i){f(`/login?redirect=/restaurant-admin`);return}if(i.role!==`restaurant_admin`&&i.role!==`customer`){E(`Access Restricted. You are currently logged in as a `+i.role+`. Only Restaurant Admins or onboarding partners can access this portal.`),w(!1);return}G(!1);let e=window.location.pathname.startsWith(`/zingbite`)?`/zingbite/api/stream?topic=restaurant_orders`:`/api/stream?topic=restaurant_orders`,t=new EventSource(e);return t.onmessage=e=>{try{let t=JSON.parse(e.data);if(console.log(`[ZingBite SSE] Received real-time restaurant dashboard update:`,t),t&&(t.event===`new_order`||t.event===`new_request`))try{let e=new Audio(`https://assets.mixkit.co/active_storage/sfx/2869/2869-84.wav`);e.volume=.5,e.play()}catch(e){console.log(`Audio play blocked by browser autoplay policy:`,e)}G(!0)}catch(e){console.error(`[ZingBite SSE] Error on message:`,e)}},t.onerror=e=>{console.error(`[ZingBite SSE] EventSource connection error:`,e)},()=>{t.close()}},[i,s]),(0,g.useEffect)(()=>{H(v)},[R,b]),(0,g.useEffect)(()=>{W(v)},[B,b]);let ce=async e=>{if(e.preventDefault(),!D.name||!D.cuisine||!D.address||!D.licenseNo||!D.aadhaarNo||!D.gstNo){y(`Please fill out all required fields.`,`warning`);return}A(!0);try{await n.post(`/api/restaurant-admin`,{action:`submitRestaurantRequest`,name:D.name,cuisine:D.cuisine,address:D.address,deliveryTime:D.deliveryTime,imagePath:D.imagePath||void 0,licenseNo:D.licenseNo,aadhaarNo:D.aadhaarNo,gstNo:D.gstNo}),y(`Onboarding request submitted successfully! Super admin will verify your documents.`,`success`),await G()}catch{y(`Failed to submit onboarding request.`,`error`)}finally{A(!1)}},le=async(e,t)=>{try{await n.post(`/api/restaurant-admin`,{action:`toggleAvailability`,menuId:e,isAvailable:!t}),C(n=>({...n,menu:(n.menu||[]).map(n=>n.menuId===e?{...n,isAvailable:!t}:n)}))}catch{y(`Failed to update availability.`,`error`)}},ue=async e=>{if(e.preventDefault(),!M.name||!M.price||!M.description){y(`Please fill out all required fields.`,`warning`);return}F(!0);try{await n.post(`/api/restaurant-admin`,{action:`addMenuItem`,name:M.name,price:parseFloat(M.price),description:M.description,imagePath:M.imagePath||void 0,restaurantId:S.restaurant.restaurantId}),j(!1),N({name:``,price:``,description:``,imagePath:``}),await G()}catch{y(`Failed to add menu item.`,`error`)}finally{F(!1)}},de=async(e,t)=>{L(e);try{await n.post(`/api/restaurant-admin`,{action:`updateOrderStatus`,orderId:e,status:t}),await G()}catch{y(`Failed to update order status.`,`error`)}finally{L(null)}},fe=t=>{let n=(e=>{switch(e){case`PLACED`:return 0;case`ACCEPTED`:return 1;case`PREPARING`:return 2;case`READY_FOR_PICKUP`:return 3;case`PICKED_UP`:return 4;case`OUT_FOR_DELIVERY`:return 5;case`DELIVERED`:return 6;default:return 0}})(t.status);return(0,_.jsx)(`div`,{className:`premium-stepper-container`,children:(0,_.jsx)(`div`,{className:`premium-stepper`,children:[{key:0,label:`Placed`,statusName:`ACCEPTED`,actionLabel:`Accept Order`},{key:1,label:`Accepted`,statusName:`PREPARING`,actionLabel:`Start Cooking`},{key:2,label:`Preparing`,statusName:`READY_FOR_PICKUP`,actionLabel:`Mark Ready`},{key:3,label:`Ready for Pickup`,statusName:`PICKED_UP`},{key:4,label:`Picked Up`,statusName:`OUT_FOR_DELIVERY`},{key:5,label:`Out for Delivery`,statusName:`DELIVERED`},{key:6,label:`Delivered`,statusName:`DELIVERED`}].map((r,i)=>{let a=n>i,o=n===i,s=n<i,l=r.actionLabel&&n===i,u=`stepper-node`;return a&&(u+=` completed`),o&&(u+=` active`),s&&(u+=` pending`),l&&(u+=` actionable`),(0,_.jsxs)(g.Fragment,{children:[i>0&&(0,_.jsx)(`div`,{className:`stepper-line ${a||o?`active`:``}`}),(0,_.jsxs)(`div`,{className:u,children:[l?(0,_.jsxs)(`button`,{disabled:I===t.orderId,onClick:()=>de(t.orderId,r.statusName),className:`stepper-btn-node`,title:r.actionLabel,children:[I===t.orderId?(0,_.jsx)(d,{className:`spin`,size:14}):i===0?(0,_.jsx)(e,{size:14}):i===1?(0,_.jsx)(h,{size:14}):i===2?(0,_.jsx)(c,{size:14}):(0,_.jsx)(e,{size:14}),(0,_.jsx)(`span`,{className:`stepper-btn-label`,children:r.actionLabel})]}):(0,_.jsx)(`div`,{className:`stepper-circle`,children:a?(0,_.jsx)(c,{size:14}):i+1}),(0,_.jsx)(`span`,{className:`stepper-label`,children:r.label})]})]},r.key)})})})};if(s||ae)return(0,_.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,alignItems:`center`,flex:1,minHeight:`400px`},children:(0,_.jsx)(d,{size:36,style:{animation:`spin 1s linear infinite`,color:`var(--brand-red)`}})});if(T)return(0,_.jsxs)(`div`,{style:{maxWidth:`600px`,margin:`80px auto`,textAlign:`center`,padding:`32px`,background:`#fff`,border:`1px solid var(--border-medium)`,borderRadius:`12px`,boxShadow:`var(--shadow-md)`},className:`fade-in`,children:[(0,_.jsx)(r,{size:48,style:{color:`var(--brand-red)`,marginBottom:`16px`,margin:`0 auto 16px`}}),(0,_.jsx)(`h3`,{style:{fontSize:`1.4rem`,fontWeight:800},children:`Access Restricted`}),(0,_.jsx)(`p`,{style:{color:`var(--text-secondary)`,marginTop:`8px`,marginBottom:`24px`},children:T}),(0,_.jsxs)(`div`,{style:{display:`flex`,justifyContent:`center`,gap:`12px`},children:[(0,_.jsx)(`button`,{onClick:()=>f(`/login?redirect=/restaurant-admin`),className:`btn-primary`,style:{width:`auto`,padding:`10px 20px`,fontSize:`0.9rem`,borderRadius:`4px`},children:`Switch Account`}),(0,_.jsx)(`button`,{onClick:async()=>{await a(),f(`/login?redirect=/restaurant-admin`)},className:`portal-logout-btn`,children:`Logout`})]})]});let{restaurant:K,menu:pe=[],orders:q=[],request:J}=S||{},Y=(q||[]).filter(e=>(e.status||``).toLowerCase()===`delivered`),X=(q||[]).filter(e=>(e.status||``).toLowerCase()!==`delivered`).length,Z=Y.reduce((e,t)=>e+(t.total||0),0),me=Y.length>0?Z/Y.length:0;if(!K){let e=J&&J.status===`Pending`,t=J&&J.status===`Rejected`;return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`style`,{children:`
        ...
        .restaurant-img:hover {
          transform: scale(1.08) rotateY(-4deg) translateZ(8px);
        }
        .banner-details {
          display: flex;
        ...
        .banner-title:hover {
          text-shadow: 0 2px 8px rgba(0,0,0,0.5), 0 0 20px rgba(247,55,79,0.1);
        }
        .banner-badge {
        ...
        @keyframes badgePulse {
          0%, 100% { box-shadow: 0 2px 8px rgba(247, 55, 79, 0.3); }
          50% { box-shadow: 0 2px 16px rgba(247, 55, 79, 0.5), 0 0 24px rgba(247, 55, 79, 0.1); }
        }
        .banner-subtext {
          display: flex;
          align-items: center;
        ...
        .kpi-card:hover {
          transform: translateY(-5px) translateZ(12px) rotateX(2deg) scale(1.015);
          box-shadow: 0 16px 40px rgba(247,55,79,0.1), 0 8px 24px rgba(0,0,0,0.04);
        ...
        .kpi-card:hover .kpi-icon-wrap {
          transform: scale(1.1) rotateY(-6deg) translateZ(4px);
        }
        .kpi-card.revenue .kpi-icon-wrap { background: rgba(96, 178, 70, 0.1); color: var(--success); }
        .kpi-card.active-orders .kpi-icon-wrap { background: rgba(255, 159, 64, 0.1); color: #ff9f40; }
        .kpi-card.total-orders .kpi-icon-wrap { background: rgba(54, 162, 235, 0.1); color: #36a2eb; }
        .kpi-card.avg-value .kpi-icon-wrap { background: rgba(153, 102, 255, 0.1); color: #9966ff; }
        .kpi-info { display: flex; flex-direction: column; }
        .kpi-label { font-size: 0.8rem; font-weight: 600; color: var(--text-secondary); }
        .kpi-value { font-size: 1.4rem; font-weight: 800; color: var(--text-primary); margin-top: 2px; }
        .kpi-badge {
          position: absolute; top: 10px; right: 12px;
          font-size: 0.65rem; font-weight: 700; padding: 2px 6px; border-radius: 8px; text-transform: uppercase;
          transition: transform 0.3s ease;
        }
        .kpi-card:hover .kpi-badge { transform: translateZ(4px); }
        .kpi-badge.positive { background: rgba(96, 178, 70, 0.1); color: var(--success); }
        .kpi-badge.text { background: var(--bg-surface); color: var(--text-muted); }
        .kpi-badge.pulsing {
          background: rgba(226, 55, 68, 0.1); color: var(--danger);
        ...
        .profile-label { font-size: 0.75rem; font-weight: 600; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 0.5px; }
        .profile-value { font-size: 0.9rem; font-weight: 700; color: var(--text-primary); }
        .code-font { font-family: monospace; letter-spacing: 0.5px; }
        .stacked-bar-container {
          display: flex; height: 12px; border-radius: 6px; overflow: hidden; background: var(--bg-surface); margin-bottom: 16px;
        }
        .stacked-segment { height: 100%; transition: width 0.3s ease; }
        ...
        .stacked-legend { display: flex; flex-direction: column; gap: 8px; }
        .legend-item { display: flex; align-items: center; gap: 8px; font-size: 0.8rem; font-weight: 600; color: var(--text-secondary); }
        ...
        .tab-bar {
          display: flex;
          background: linear-gradient(145deg, var(--bg-surface) 0%, #f0f0f5 100%);
          border-radius: 30px;
          padding: 6px;
          margin-bottom: 28px;
          gap: 4px;
        ...
        .tab-btn {
          ...
          cursor: pointer;
          border-radius: 24px;
          transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1), transform 0.4s cubic-bezier(0.25, 0.8, 0.25, 1);
          white-space: nowrap;
          transform-style: preserve-3d;
        }
        .tab-btn:hover { transform: translateZ(4px); }
        .tab-btn.active {
          background: white;
          color: var(--brand-red);
        ...
        .btn-primary:active { transform: translateY(0) translateZ(0) scale(0.98); }
        .menu-grid {
          display: grid;
        ...
        .menu-item-card:hover {
          ...
          box-shadow: 0 20px 48px rgba(247,55,79,0.1), 0 8px 24px rgba(0,0,0,0.06);
          border-color: rgba(247, 55, 79, 0.2);
        }
        ...
        .admin-toggle-switch:hover { transform: translateZ(2px); }
        .admin-toggle-switch.available { background-color: var(--success); }
        .admin-toggle-knob {
          position: absolute;
          top: 3px;
          left: 3px;
        ...
        .admin-toggle-switch.available .admin-toggle-knob { transform: translateX(24px); }
        .animate-card {
          animation: cardFadeInUp3D 0.55s cubic-bezier(0.25, 0.8, 0.25, 1) both;
        }
        @keyframes cardFadeInUp3D {
          from { opacity: 0; transform: translateY(24px) translateZ(-12px) scale(0.95); }
        ...
        .order-card:hover {
          transform: translateY(-4px) translateZ(10px) rotateX(1deg);
        ...
        .order-info-section { flex: 2; min-width: 280px; }
        .order-actions-section {
          flex: 1; min-width: 200px; display: flex; flex-direction: column; align-items: flex-end;
        ...
        .customer-name { font-weight: 700; font-size: 0.95rem; color: var(--text-primary); margin-bottom: 8px; display: flex; align-items: center; gap: 6px; }
        .customer-detail { display: flex; align-items: center; gap: 8px; font-size: 0.85rem; color: var(--text-secondary); margin-top: 6px; }
        .call-customer-btn {
          display: inline-flex; align-items: center; gap: 4px;
          background: rgba(96, 178, 70, 0.1); color: var(--success);
          border: 1px solid rgba(96, 178, 70, 0.2); padding: 4px 10px; border-radius: 12px;
          font-size: 0.75rem; font-weight: 700; cursor: pointer; margin-left: 8px;
        ...
        .modal-content {
          ...
          max-width: 500px; width: 100%; box-shadow: 0 16px 48px rgba(0,0,0,0.15);
          animation: modalIn 0.3s cubic-bezier(0.25, 0.8, 0.25, 1) both;
          transform-style: preserve-3d;
        }
        @keyframes modalIn {
          from { opacity: 0; transform: translateY(20px) translateZ(-20px) scale(0.95); }
          to { opacity: 1; transform: translateY(0) translateZ(0) scale(1); }
        }
        .portal-logout-btn {
          display: flex; align-items: center; gap: 6px;
          background: none; border: 1px solid var(--border-medium);
          color: var(--text-secondary); font-weight: 700; padding: 8px 16px;
        ...
        .portal-banner-logout-btn {
          ...
          font-weight: 700; padding: 10px 20px; border-radius: 24px; cursor: pointer;
        ...
        .form-group input:hover, .form-group textarea:hover { transform: translateZ(2px); border-color: rgba(247,55,79,0.2); }
        .form-group input:focus, .form-group textarea:focus {
          border-color: var(--brand-red); transform: translateZ(4px);
          box-shadow: 0 0 0 3px rgba(247,55,79,0.08);
        }
        .badge {
          padding: 6px 12px; border-radius: 12px;
          font-size: 0.75rem; font-weight: 700; text-transform: uppercase;
          letter-spacing: 0.5px; transition: transform 0.3s ease, box-shadow 0.3s ease;
          display: inline-block;
        }
        .badge:hover { transform: translateY(-1px) translateZ(4px) scale(1.05); box-shadow: 0 2px 8px rgba(0,0,0,0.08); }
        ...
        .pill-filter {
          padding: 8px 16px; border: 1px solid var(--border-medium); border-radius: 24px;
          background: white; cursor: pointer; font-weight: 700; font-size: 0.85rem;
          color: var(--text-secondary);
          transition: all 0.3s ease, transform 0.3s ease;
          white-space: nowrap; box-shadow: 0 2px 6px rgba(0,0,0,0.02);
          transform: translateZ(0);
        }
        .pill-filter:hover {
        ...
        .pill-filter.active {
          ...
          color: white; box-shadow: 0 4px 12px rgba(247, 55, 79, 0.2);
          transform: translateY(-1px) translateZ(6px);
        }
        .hide-scrollbar::-webkit-scrollbar { display: none; }
        
        .premium-stepper-container {
          width: 100%; padding: 16px 8px 0; margin-top: 16px;
        ...
        .stepper-line {
          flex: 1; height: 3px; background: var(--border-medium);
          margin: 0 -8px; transform: translateY(-12px);
          transition: background-color 0.3s ease;
        }
        .stepper-line.active { background: var(--success); }
        .stepper-node {
          display: flex; flex-direction: column; align-items: center;
          position: relative; z-index: 5; min-width: 60px;
        }
        .stepper-circle {
          width: 28px; height: 28px; border-radius: 50%;
          background: white; border: 2px solid var(--border-medium);
          display: flex; align-items: center; justify-content: center;
          font-size: 0.78rem; font-weight: 700; color: var(--text-muted);
          transition: all 0.3s ease, transform 0.4s cubic-bezier(0.25, 0.8, 0.25, 1);
          transform: translateZ(0);
        }
        .stepper-node:hover .stepper-circle:not(.active):not(.completed) {
        ...
        .stepper-node.active .stepper-circle {
          background: white; border-color: var(--brand-red); color: var(--brand-red);
          box-shadow: 0 0 0 3px rgba(247, 55, 79, 0.15);
          animation: nodePulse3D 1.5s infinite;
          transform: translateZ(4px) scale(1.05);
        }
        @keyframes nodePulse3D {
          0% { box-shadow: 0 0 0 0px rgba(247, 55, 79, 0.3); transform: translateZ(4px) scale(1.05); }
          70% { box-shadow: 0 0 0 6px rgba(247, 55, 79, 0); transform: translateZ(6px) scale(1.1); }
          100% { box-shadow: 0 0 0 0px rgba(247, 55, 79, 0.3); transform: translateZ(4px) scale(1.05); }
        }
        .stepper-node.pending .stepper-circle { background: var(--bg-surface); border-color: var(--border-medium); color: var(--text-muted); }
        .stepper-btn-node {
          display: flex; align-items: center; gap: 6px;
        ...
        .stepper-btn-node:hover {
          transform: translateY(-14px) translateZ(8px) scale(1.05);
          box-shadow: 0 6px 16px rgba(75, 192, 192, 0.4);
        }
        .stepper-btn-node:disabled { background: var(--border-medium); box-shadow: none; cursor: not-allowed; animation: none; }
        .stepper-btn-label { white-space: nowrap; }
        .stepper-label {
          font-size: 0.72rem; font-weight: 700; color: var(--text-muted);
          margin-top: 6px; white-space: nowrap; text-align: center;
          transition: color 0.3s ease, transform 0.3s ease;
        }
        .stepper-node.completed .stepper-label, .stepper-node.active .stepper-label { color: var(--text-primary); }
        .stepper-node.actionable .stepper-label { margin-top: -6px; color: var(--text-primary); }
        ...
        @media (max-width: 768px) {
          .admin-container { margin: 20px auto; padding: 0 16px; }
          .restaurant-header-banner { flex-direction: column; align-items: center; text-align: center; padding: 32px 20px; gap: 20px; }
          .banner-info-wrap { flex-direction: column; align-items: center; gap: 16px; width: 100%; }
          .banner-details { align-items: center; }
          .banner-title-row { flex-direction: column; align-items: center; gap: 8px; }
          .banner-title { font-size: 1.8rem; }
          .banner-subtext { justify-content: center; font-size: 0.88rem; }
          .tab-bar { max-width: 100%; width: 100%; }
          .tab-btn { flex: 1; text-align: center; padding: 10px 12px; font-size: 0.88rem; }
          .search-bar-container { flex-direction: column; align-items: stretch; gap: 12px; }
          .search-input-wrapper { width: 100%; min-width: 100%; }
          .search-bar-container button { width: 100%; justify-content: center; }
          .order-card { flex-direction: column; align-items: stretch; gap: 16px; padding: 16px; }
          .order-info-section { min-width: 100%; }
          .order-actions-section { align-items: flex-start; min-width: 100%; text-align: left; margin-top: 8px; }
          .order-actions-section div { text-align: left !important; }
          .order-actions-section button { width: 100%; }
        }
        @media (max-width: 600px) {
          .modal-content { padding: 20px; margin: 12px; }
          .premium-stepper-container { padding: 12px 0 0; }
          .stepper-label { font-size: 0.65rem; }
          .stepper-btn-node { padding: 6px 10px; font-size: 0.72rem; }
        }
        @media (max-width: 480px) {
          .stepper-label { display: none; }
          .stepper-node { min-width: 32px; }
          .stepper-circle { width: 22px; height: 22px; font-size: 0.65rem; }
          .stepper-line { transform: translateY(-9px); height: 2px; }
          .stepper-btn-node { transform: translateY(-9px); padding: 4px 8px; font-size: 0.68rem; }
          @keyframes actionPulseRider {

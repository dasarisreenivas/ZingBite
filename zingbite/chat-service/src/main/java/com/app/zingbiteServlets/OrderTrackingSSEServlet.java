...
public class OrderTrackingSSEServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isRestaurantAdmin = "restaurant_admin".equalsIgnoreCase(loggedInUser.getRole()) &&
                order.getRestaurantId() != null && order.getRestaurantId().getAdminId() != null &&
        ...
        boolean isAssignedRider = "delivery_partner".equalsIgnoreCase(loggedInUser.getRole()) &&
                order.getRiderId() != null && order.getRiderId() == loggedInUser.getUserID();
        ...
        // Set SSE headers only after validation. Error responses must retain a normal
        // error content type so clients can reliably reject unauthorized streams.

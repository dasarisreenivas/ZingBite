...
public class Orders implements Serializable{
	...
	@Column(name = "surgeMultiplier", nullable = false, columnDefinition = "float default 1.0")
	private float surgeMultiplier = 1.0f;

	@Column(name = "surgeFee", nullable = false, columnDefinition = "double default 0.0")
	private double surgeFee = 0.0;

	@Column(name = "surgeReason")
